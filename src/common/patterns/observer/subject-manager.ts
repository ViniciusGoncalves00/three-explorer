// import { Logs } from '../../../core/api/logs';
...
//             Logs.getInstance().log(LogType.Warning ,`Observer [${observerName}] already attached in subject [${subjectName}].`);
//             return;
//         }
...
//             const subjectName: string = subject.constructor.name.toUpperCase();
//             const observerName: string = observer.constructor.name.toUpperCase();
//             Logs.getInstance().log(LogType.Warning, `Observer [${observerName}] not found in subject [${subjectName}].`);
//             return;
//         }
