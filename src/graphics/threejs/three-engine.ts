...
//   constructor(engine: Engine, binder: ObjectBinder, containerEditor: HTMLElement, canvasA: HTMLElement, containerSimulator: HTMLElement, canvasSimulator: HTMLElement) {
//     this._engine = engine;
//     this._binder = binder;

//     this.scene = new ThreeScene();
//     this.rendererEditor = new RendererManager(containerEditor, canvasA);
